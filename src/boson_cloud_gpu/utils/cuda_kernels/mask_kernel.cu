...
mask_array(const float *frequency, const float *tau_gw, const float *tau_inst,
           const float *bh_age_sec, const float *alpha, const float *spin,
           const float *chi_c, const float *f_dot, const float *df_dot,
           const int nrows, const int ncols, float *masked_frequency,
